...
function []=Visualizer_Q2(joint_angles)
...
configNow = [joint_angles(1) joint_angles(2) joint_angles(3) joint_angles(4) joint_angles(5) joint_angles(6)];
